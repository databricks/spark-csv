...
case class CsvRelation protected[spark] (
    ...
    codec: String = null,
    nullValue: String = "",
    dateFormat: Seq[String] = null)(@transient val sqlContext: SQLContext)
  ...
  private val dateFormatter = if (dateFormat != null && dateFormat(0) != null) dateFormat.map(df => new SimpleDateFormat(df)) else null
